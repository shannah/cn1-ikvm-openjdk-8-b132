    ...
    extends CertStoreHelper
{
    ...
    {
        return null;//LDAPCertStore.getInstance(LDAPCertStore.getParameters(uri));
    }
    ...
    public X509CertSelector wrap(X509CertSelector selector,
        ...
        throws IOException
    {
        return null;// new LDAPCertStore.LDAPCertSelector(selector, certSubject, ldapDN);
    }
    ...
    public X509CRLSelector wrap(X509CRLSelector selector,
        ...
        throws IOException
    {
        return null;// new LDAPCertStore.LDAPCRLSelector(selector, certIssuers, ldapDN);
    }
